...
③	47 57 67 77 87		④	43 53 63 73 83

∙ int *ptr = a + 3; → 포인터 변수 ptr은 a[3]의 값인 40을 가리킵니다.
∙ i = 0일 때 : *(ptr+i)-3은 a[3] - 3이므로 37이 출력됩니다.
∙ i = 1일 때 : *(ptr+i)-3은 a[4] - 3이므로 47이 출력됩니다.
∙ i = 2일 때 : *(ptr+i)-3은 a[5] - 3이므로 57이 출력됩니다.
∙ i = 3일 때 : *(ptr+i)-3은 a[6] - 3이므로 67이 출력됩니다.
∙ i = 4일 때 : *(ptr+i)-3은 a[7] - 3이므로 77이 출력됩니다.
