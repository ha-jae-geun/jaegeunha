...
* 재택 근무제를 도입하다 / introduce a telecommuting system (for 2 days) 
	* '집에서 일하다'는 work at home이라고 표현해도 무방하지만, work at home은 공식적으로 재택근무가 아니라, 그냥 집에서 일하는 거라는 뉘앙스입니다. 재택근무하다'는 work from home이라고 하는 게 좀 더 명확한 의미전달이 될 것 같습니다. ^^
...
* #유통회사; #distribution company
* #창업; foundation, establishment, founding, (formal) inception, found, establish, start, set up 
#firm
...
--------
* #상표
* #Dramamine(쥬라마민); 멀미약 상표
* #band-aid 데이밴드 
* #Sweet ‘N lows; 설탕 감미료 상표 이름
* #Purell; #세정제; did he purrel
* ##division #부서# ##department #과#
* http://blog.naver.com/skybels/220986343682 
...
* #마케팅 #전략부 Marketing & Strategy department
* #internet marketingl #cost per click; #click-trhoguh rate
* #홍보 #promotion = #public relation activity/officer/division
* #advertise, #publicize, #promote - 홍보하다
* #publicity; good bad adverse publicity
* #홍보 대사; #honary #ambassador
* 홍보 투어; #press tour
* #기획부; #planning Dept
* #기계사업부; #machinery division
* #기술 연구소; echnical research center / research institute
* #관리 본부; #management division
* #네트워크사업부; #network business division
* #마케팅 사업부; #marketing business dept.
* #무역부 #international Dept
* #무역수지; #trade balance 
* #총무부; #general affairs dept
* #경리부; #accounting dept
* #시스템 사업부; #department of System integration
* #시설 관리부; #facilities management dept
* #구매부; purchasing dept
* #재정부; #finance & accounting Dept
...
* #개발팀; #R&D team; research and development team
* #coined; #new-coined; 새로 만든ㄴ
* #관리팀; #management team
...
* #고용 동향; #employment trend/tendency
* #평생 고용 #lifetime employment / #lifelong employment
* #고용인; #attendant, #assitant, #guard - 고용인 
...
* #유지관리비; #maintenance fee
* #생산 라인, #유지 비용, #외부 제작, #본사 
product #line, #maintenance costs, #outsource, #home office
* #just-in-time; 적기 공급[무재고] 생산 방식의
* ##product; #제품; #merchandise #items #goods #effects #article #commodity
* #생산하다; #turn out #chrun out; #churn something out
* #생산성을 저하시키다 #discourage productivity
* ~의 생산량의 ~#퍼센트를 생산한다; produce ~% of the country's something
* #명함을 주고받다 							exchange business card
* 그는 목요일 오후 일을 뺐어 				 He's taking thrusday afternoon off now
* 나는 네가 회사로 #복귀하길 바래 	 I would love for you to come back to work
  #return
* [동사] (직장・직책 등에로) 복귀시키다 He was #reinstated in his post.
* ☆*다시 #컴백하려고요 							 #Back in the saddle
* #saddle up; 나갈 준비를 하다; saddle up on a horse
* be saddle with #debt/#responsability; #짊어지다;
* 다시 회사 가야돼 I have to head off to work
* 보던 일 봐 							 I'll let you get back to work
* 나는 회사에 있어 								 I’m at work
* 제가 없는 동안 ~해줄 수 있나요? 				 While I'm gone, could you?
* #조퇴 #take the #rest of the day ##off
* #인턴 했었어 									 I interned here 
What internships are you going to apply for?; begin his summer internship
* #견습생 #연습생 #entry-level position
* #임시직 직원 #Tempoary work = #temp
* #칼퇴 finish work on time
* #반차 						 half day; i'm wanna work a half day today
* #실적 예상 실적에 크게 못 미쳤잖아		We #missed our projection by quite a bit ()
* #매출 실적표; #sales performance
* #performance; 실적; #경영 실적; #managemnt performance
* 거래 실적 business performance
* 매출 실적 sales achievements
* 분야별 실적 performance by segment
* 사업 실적 business record[results]
* 사용 실적(카드) credit card usage level[grade]
* 수출 실적 export figures
...
* 제가 생각했던 것 보다 조금 더 비싸네요		 It’s a little bit more expensive than I thought
...
* ○ He'll be leaving at the end of next month (담달말에 관둔대)
* ○ I've been offered a job in Europe (나 유럽회사에서 잡 오퍼 받았다)
----------
* 그는 회사 시간을 낭비하고 있었기 때문에 해고 당했다. 		 They gave him the pink slip
* 그는 해고 당했어 			He got fired. He got the sack.= get #canned
* #잘리다(팀에서) be #cut from group; after being cut from his high school
* #sacked; He got the sack for swearing.
* 회사에 구조조정이 있을 시에 대부분 상위권 간부들이 먼저 해고당한다. 		 
* #get chop(#chop)
* #축출 #제명; #expulsion; the expulsion of a member from a club
* 해고당하다	 When a company is restructured, the senior staffs are often the first to get the axe.
* #송별회 #환송회 #going away #party
* make a clean sweep; 말끔히 정리하다
* #정리 해고; Thousands of factory workers are facing #redundancy.
* made redundant; I was made redundant
* #제대로 하지 않을 거라면 나가라; #shape up or ship out; #shape up; #열심히
* ☆#제대로 하다; #propely; do one's job; she wasn't even doing her job properly
* #제대로 된; we're getting a real #gardner
* #해고
* #일상
* #용어; #jargon
* term, terminology, (formal) phraseology 용어 선택에 주의하다
* choose[use] the terms carefully 
* 사람, 기관 announced that
* #gamification 게임(Game)과 접미사 ‘화(化, fication)’를 합친 신조어로 게임에서 흔히 볼 수 있는 재미·보상·경쟁 등의 요소를 다른 분야에 적용하는 기법이다. | 
기업이 의도하는 활동에 사용자의 참여를 유도하기 위해 게임과 무관한 웹 사이트나 애플리케이션에서 게임과 연관된 개념을 활용하는 것 (동사형은 gamify) 
* #announcement, #statement, #declaration - 발표 (소식) 
* 오늘 회사에서 발표했어 					 I gave a presentation at work today
* #취임식을 거행하다. 						 have/hold an inauguration (for)
* #창단식; #Inauguration ceremony
...
* #발표하다, #공표하다; #make public(#public) = #publicize
...
* 난 회사를 어떻게 #운영하는지 전혀 몰라. I have no idea how to run a business.
* #가동되다; #operate under
...
* #용어
* ○ balance sheet (직역하면 균형 시트--> 대변(credit)과 차변(debit)이 균형을 이루는 시트, 즉 대차대조표) 
* ○ 그럼, 손익계산서는 income statement (직역하면 수입 진술서 --> 매출부터 시작해서 각종 경비를 제하고 이익(수입)이 어떻게 도출되는지를 진술한 명세서 --> 손익계산서) 
* #명세서; #specification #statement
* ○ 매출은 sales volume = sales revenue = sales figures = sales amount 
* ○ sales profit 매출이익 
...
* ○ balance sheet 대차대조표 , 
* #agent, #representative, #negotiator - 대리인, 에이전트 #agency - 기관
* ㆍ사람이름 + 부서명: 
...
* #상종; keep company with, associate (with); You're not #fit for my company! 
* #상대 #적 #라이벌 #동맹 #파트너 #동료 | #대리인 #후원자
...
* b. Work out (잘되다) 
* They dated for a while, but it didn’t work out. 
* There’s no way that plan is going to work out. 

* c. Work out (문제를 풀다) 
* You two need to work out your differences. 

* 2.Work on (작업하다, 노력하다) 
* I’ve been working on this piece for years. 
* I worked on my last book for more than three years. 

* 3.Work off (노력으로 없애다) 
* I’ve gotta work of these extra pounds. 
* It took 10 years for me to work off my debt. 

* 4. Do someone’s dirty work (남이 시켜서 궂은 일을 하다) 
* I’m not going to do your dirty work. You can fire them yourself. 

* 5. Work one’s way through college (학비 벌어서 대학교 다니다) 
* My dad always said that we should work our way through college. 

* 6. In the works (진행 중, 준비 중) 
* I’ve got many exciting projects in the works. 

* 7. Out of work (무직, 실직) 
* With so many Americans still out of work, the President will face an uphill battle in this year’s election. 

* 8. (Get) Worked up (흥분되다) 
* She got all worked up after his presentation. 
* He worked up the crowded. 

* 9. A piece of work (괴짜) 
* That guy is sure a piece of work! 

* 10. Workaround (임시변통, 제2의 해결책) 
* Well, it’s just a temporary work-around. 
...
* ~를 위해 일하다 							 work on somebody
* #된다 it's working
* ○ I work on the essay mainly at home late at night (난 주로 집에서 밤 늦게 에세이 작업을 해)
...
* not #functioning
* ○ Things will work out all right (다 잘 될거야)
* ○ Everything will work out just fine (다 잘 될거야)
* ○That works for me
...
* 일하고 있어요 I’m on #duty
* #노동 시간 #work weak
* 노동일 labor jobs , #노동자 카페; #workmen cafes
* #labour-intensive methods #노동 집약적인 방법
* #착취; The factory #wring out the force of labor. 그 공장은 노동력을 착취한다.
* 2. #짜다
* 힘들고 단조로운 일 						 drudgery 미국·영국 [|drʌdƷəri]
* 추가적인 일: additional work, 잡무: chores[tʃɔːr], duties
* #일처리 make yourself busy;(#busy) 일처리 잘하고 있다
* 네 일을 해라 								do you = do your thing
* 일 이야기는 그만하세요 							 Stop all this shoptalk
* 요즘 회사에서 미친 듯이 바빠요 Work has been crazy lately > Things have been hectic at work
* 요새 하는 일이 많아요 				I’ve got a lot on my plate right now
* 어떻게 그렇게 빨리 왔죠? 			 How did you manage to get here so quickly?
* 얼마나 오래 운전기사로서 일했어요? How long did your work as a truck dirver for/as/with 회사
* 나는 #일을 빨리 배워요.						 I pick up things quickly.
* 여러 일을 같이 진행하다 						 He has a finger in every pie.
* 일 대박 #많아. 					 swɑ:mp: 일 쇄도	 I'm swamped at work. 
* #‘할 일이 엄청 많아 				 I have a shitload of work to get down.
*  I have a lot on one’s #plate = I already have a lot going on
* *내가 할 일을 못하겠어 						 I can't function properly right now
...
* #back in business; we're back in business
* #go back; #알고 지내다
* ##상호의					mutual 미국·영국 [|mju:tʃuəl] = #reciprocal
* #하나 되어 #as one
* #협력해서 일을 해야하는 상황 						 #All hands were on deck
* #coordinate - #cooperate - #collboarte
* #collaborate on 사물; 사물에 대해 협력하다
* #연대효과; #effect of solidarity
...
#allowance, #portion, #share - 몫 
* ‘매출이나 수익의 일부분/몫						 A #slice of the pie 
* ‘일을 제대로 하는 감독관은 서류 검토를 정확하게 했을 것이다. 		 제 몫을 하다
* Any inspector worth their salt would have checked the papers carefully.
* #double #duty; 2타임 근무; 8시간의 근무를 2번 연속으로 한 것, another #double (duty)
* pull double duty
* #교대 #근무 너무 힘들어 							 Shift work is so hard.
* #flexi-time; 근무시간 자율 선택제
* #근무 환경; in what kind of work environment are you most comfortable?
* What shif do you work? I work the night/day shift
* #작업하다; to #work on; what aore you working on this late?
* 근무중이다 								 I'm still on the clock.
* ‘#초과 근무 수당 							 low overtime alowances
* #수당 실업수당을 받다 be on #unemployment benefits
* Besides the basic salary, you will be given a family allowance and #extra pay for overtime.
* #정규근무 시간을 준수; I keep regular office hours
* 초과 근무하다 									put in overtime.
* 단축 근무 							 shortened working hours.
* *#주 5일 근무입니다. 					 Our company has a five-day work week
* 근무 #태만; #remiss; remiss in/about; remiss in performing one's duties
* 우리는 #맞벌이해요! 					 My wife and I bring home the bacon.
* #밥벌이 먹고 살기 위해 일하다 						Time to work for a living
* 밥을 #축내다; you are not #worth feeding(#feeding)
* 이 피자 조각은 내 꺼. 				 dib: 몫, 1달러 I got dibs on this slice of pizza.
* #cut; #몫; ~의 몫이다; here's jessie's cut
* 11시에는 좀 아닌 것 같지만 어울리기는 해	 Not at 11 in the morning but it does #work
* #공과 사는 구분하겠어요							 I'm drawing a line
* #빡세게 가자; we need to keep this tight; #keep tight
* ☆I work long hours. #근무 시간이 길어요.
* #talk shop; #일얘기를 하다
* #근무 #빡세게 #몫 ##일# #work
* #일을 하는데 필요한 최소한읜 인원; #skeleton crew
* #drudgery; I gotta do all these drugeries
* #잡무; [mìsǝléiniǝs] do #miscellaneous work
* #잡일
* 추가 인력이 필요할 것 같애요 					 I'll add the extra mapower
* #인력
* 직급 사원, 대리, 과장, 차장, 부장, 이사
* 상무, 전무, 부사장, 대표이사, 사장	1. 사원 staff 
* #사원증; #name tag = #employee card
* 2. 대리 assistant manager 
* 3. 과장 manager/#section chief/general manager / department manager
* 과장대리: acting manager / deputy manager
* 4. 차장 senior manager 혹은 deputy manager 
* 5. 부장 general manager/ #department manager
* 6. #이사 director 
* #이사회 the board of director, #board director
#board
* 7. 상무 managing director 
* 8. #전무 #senior managing/ executive director 
* 9. 부사장 vice president 
* #지사장; #branch office president
* 10. 대표이사, 사장 CEO / president 
* #소장; #head
* #상임고문; executive adviser
* #기술고문: #technical adviser/consultant
* #감사; #auditing director / #auditor
* #사원 이사; #Outside director
* #전문위원; #expert adviser / #research fellow
* #본부장; #divison director = director
* #공장장
* #plant manager
...
* #영업사원; sales rep 
* #팀장 #team manager / Team leader / #chief / #section chief
* #부장대리; deputy general manager
* #차장; #deputy general manager / assistant directorvice-chief manager
* #계장; #subsection chief / #senior staff
* #주임; #senior clerk / senior staff / #supervisor / #assistant manager
* #수습사원; #probationary staff
* #촉탁사원; #non-regular staff
----
* #수석연구원 #principal research engineer
* #책임연구원; #senior research engineer
* #선임연구원; #research engineer
* #전임연구원 #assosiate research engineer
* #주임연구원 #assistant research engineer
* #연구원 #researcher / #research Engineer
-----
* #반장; #foreman / #squad leader; 2. foreman: ##노동자
* #노동강도; #labour intensity
* #일꾼; He would be a great #hire. 그는 훌륭한 일꾼이 될거야.
* #조장; (field) Leader / #group leader
* 주임기사; #staff engineer 
* #기사; #engineer 
* #비사; #secretary
* #지점장; #branch manager
* #CFO; #CDO #COO #COO #CMO #CIO #CTO #CLO #CLO #CRO ##CSO
* #CCO #CKO #CHO CPO
* 회사
* 내 아내는 시카고에 있는 법률 회사에서 일한다
* 작은 회사	company 회사를 지칭하는 가장 일반적인 말
firm
* 상품을 제조하여 판매하기보다는 주로 재정, 법률 등의 전문적인 서비스를 제공하는 회사
* My wife works for a law firm in Chicago.
* business 주로 소규모 기업체를 가리킴
* small business 
* ^^##올라가다; ##ascend <> ##descend
* #hoist up; hoist somebody/something up
* 그는 계속해서 사회적인 위치가 올라가는 중이다. 		 
* he has been moving up in the world.
* 너가 판매 보고서를 보면, 우리가 #우월한 위치에 있다는 것을 볼 수 있다.
* If you look at the sales report, it's clear to see that we haveIlose) the upper hand.
* #사회 전반(#전반) the society at large
* #반사회적인; #antisocial; behaviour
* #사회적 #위치 | #올라가다
* 나 개인 사업해 						#build / do personal business 
* 학교에 컴퓨터를 공급하는 계약을 따서 힘을 안 들이고 돈을 벌어들였다. 	 
* 힘안들이고 돈버는 사업
* The contract to supply computers to schools was a license to print money.
* entre·pre·neur 		 			 [|ɑ:ntrəprə|n3:(r)] 사업가,# 기업가 정신
* #사업수완가; 사업 잘하는 사람; #rainmaker
* #make good business sense 미국식 영국식 단어장추가사업적으로 좋은 의미가 된다
* #사업 | #사업가
* #gig; do a gig, #side-job 2. gig: #공연
* #알바 할거야 							 I want to get a part-time job
* I’m 25, I live in a dormitory to do a part-time job in school
* ##알바
* 잡담 그만하고, 본격적으로 일을 시작하자!				 Let's get down to business!
...
* 성공적인 행동을 가져오는 절묘한 행동; #master stroke(#stroke) it was a master stroke
* 클라이언트들이 자기를 떠나기 직전에 나는 #성공을 이뤄낼 수 있었다. (계약을 따낼 수 있었다.) 
* ‘이번에 새 직장에서 네가 꼭 #대성공을 거두길 바랄게! I hope you strike gold this time with your new job! 
* I got #home and hosed. 나는 성공했다. / be home and dry
* #성공; 대박; if this business takes off, we could make a lot of money
* #go places; go places - 성공하다, 이기다
* #go a long way, #make good, #do well, #hit the mark(#mark), hit the #bull's eye 성공하다;
* #출세하다; #get on in the world = #succeed in life
* 출세가도; #ladder of success
* #triumphant; 성공한; they emerged triumphant
* ‘다른 아이디어를 제치고 압도적인 #지지를 얻었다. 압도적인 승리 it won in a landslide against the other ideas.
* * ‘그 사람 날 지지해줬어.							 He stood up for me.
...
* #승자 #top dog
* #연승; be on a winning streak, successive[consecutive] victories, victories in a row, winning streak;  ~’s win streak continues
* #승률; have a high winning rate
* #압승; #landslide; I won by a landslide
* Roosevelt and Churchill led democracy to victory. 루즈벨트와 처칠은 민주주의를 승리로 이끌었다.
* #바르다; #destroy ~
* ‘커리어를 향해 #순항하다 			 appeared on track for a huge career
* ‘너가 판매 보고서를 보면, 우리가 #우월한 위치에 있다는 것을 볼 수 있다.
* If you look at the sales report, it's clear to see that we haveIlose) the upper hand.
* ‘난 그것을 #해낼수 있었어요.		 I could manage to make it, pull off, nail
* #그럭저럭 때우다; #make do with
* #make it out
* we #get there in the end
* #가까스로 해내다; #by the skin of your teeth; he escaped from the ~ by the skin of his teeth
* *해낼 수 있을지 모르겠어				 I don't see how we can pull off
* ‘그녀는 해냈다. 		 she almost succeeded, go thorugh with #succeed in: 잇다
* #succeed A as B = #replace A as B
* ‘당신이 없었으면 못 해냈을 거예요			 .I couldn't have done it without you.
* put something through; 어떤 일을 해내다, #완성하다
* ‘나 해냈어!! 								 I made it. I nailed it.
* #번영, #번창; #prosperous = #thrive; #prosperity
* #home free; 해내다; i'm home free
* 실패 두려워 하지마, 다시 시작하면 되잖아 				You can always give it another go.
* 시도해 봤으나 실패하다; #try in vain
* #낙제 #flunk; flunk at life
* #miscarry #miscarriage; 실패 2. #유산
* #실패 직전 성공 Just before the client left, I was able to snatch victory from the jaws of defeat.
* it was #failure of ~
* #debacle 미국·영국 [deɪ|bɑ:kl;dɪ|bɑ:kl] ; the global financial debacle. / #data debacle
* ‘일이 잘 실현되지 않다 				 Our plans fell through because of lack of money.
* ‘실패할 것이 확실한 프로젝트 						 #duck a #dead duck
* ‘크게 #실패할 용기 있는 자만이 크게 이룰 수 있다 
* Only those who dare to fail greatly can ever achieve greatly 
* ‘실패했다고 너무 실망하지 마라 / 실패를 이겨내라 Don't let your failures get the better of you.
* #실패작, 먹튀 						 bʌst 부수다, 강등 시키다 bust/flop
* #불발탄 #dud
* #misfire; #불발에 그치다;
* ‘실패작이었어요 					 It was a total flop/dud/complete fiasco.
* 큰 실패 #miss by a mile(#mile)
* 실패할 염려가 없는; #fooprrof; that was a foolproof plan
* #strike out; You strike out, you resign. 니가 실패하면, 니가 사직하는 거야
* ‘우리는 #제대로 되는게 없다 				we haven't fired/hit/clicked on all cylinders 
* ‘제대로 된 										#legit ~
* ‘너 거의 이길뻔했는데 결국 못했구나~ 		 과거 상: cigar You were close, but no cigar!
* 계산을 잘못하는 바람에 (지금까지 해 온) 프로젝트가 #무산되었다.
...
* #outexecute; (sports) To execute plays more successfully than another person or team
* ☆#발라버리다; #own; i'll own you; team A totally owned Team B
* 스스로를 이기다 conquer oneself
* 누가 이기고 있어? Which team is leading?
* #jubilation 미국·영국 [|dƷu:bɪ|leɪʃn]; feel jubilation; jubilation at
* #패배시키다 승자 + #defeat; 싸움, 전쟁 #beat; 득점; 경기, 시합;, 선거(vote) + 패자
* #패배: lose = #rout#
* #연패; suffer #successive[straight] defeats 
* #궤멸시키다; put somebody to #rout#
* 우리는 게임에서 패배했다; we suffered a crushing defeat = we #crushed = we were soudly defeated
* #구현 #실현 #순항 #궤도 #승승장구 #성패 #승리 #이기다 #해내다 #패배 #성공 #실패 #무산 #먹튀
* ^^##blame; #탓하다
* ##fault; #명사; #탓; it's not my fault
* 잘못하다; I didn't do something wrong
* ##criticize; #비난하다
* #dis# #dissing
------
* 힘든 한 주를 보냈으니까, 네가 그것을 들지 못하더라도 널 탓하지는 않을게.
* You've had a tough week, we won't hold it against you if you can't get it up.
* 'Hold it against someone' 은 '~를 원망하다, 탓하다' 
* ☆i was #left hoding the bag in the end
* #책임감 강하다 #high sense of responsibility = #consistent, = #follow-through
* to have things on someone's plate(#plate); 책임지고 마쳐야할 일들이 있다.
* be responsible for –ing, #carry the ball; 어떤 일을 책임지고 처리하다 = take the responsible
* #accountability; #책임
* ☆ #follow-throuugh; 끝까지 노력하는것; that guy has no follow-through
* 책임을 떠맡다; #키를 잡다; take the #helm
* #on the hook; (#hook) 책임이 있다
* 책임 지다; #answer for = #take responsible for; you will have to answer for your behavior
* #see to = #deal with = #take charge of
* be #attributed to something/ -ing
* #pay the piper(#piper)
* 담당자는 없어 담당자는 없어.					 There is no man in charge.
* 제가 판매 담당입니다							 I'm in charge of sales. 
* 박씨는 다음 프로젝트를 리드할 것이다. 	 Mr.park will be in the driver's seat for the next project.
* 나한테 뭐라고 하지마 			 Don't blame it on me. Don't blame me for that.
* ~의 책임이 아니다 							 That's not on ~
* 바르톨로 콜론은 메츠의 공격진을 탓하지 않았다. Bartolo Colon doesn't throw Mets' offense under bus
* 군인들의 사망은 정부에 책임이 있다. 
* ‘gʌvərnmənt ’laɪəbl ‘soʊldƷə(r) 	 The government is liable for the loss of soldiers. 
* 책임 떠밀지 마 						 Don't pass the buck to me
* ☆#shirk; don't shirk your responsabilities
* 회사에 입사한 순간부터 본인 스스로 노력을 하고 본인 스스로 책임을 져야한다.
* Once you start working for the company, it's sink or swim.
* 네 탓 아니야 								 You're not to blame.
* 다 내 책임이야 I take full responsibility
* 일이 이렇게 된 것은 그의 책임이다; he is to blame for this #state of affairs
* 내 탓으로 돌리다; #throw me under the bus; #bus
* #turn on; #책임 돌리다; don't turn this on me
* ☆책임을 돌리다; We can't let them take the fall.
* #탓 ##책임 #담당 # in charge of
* blame + 명사; don't blame him 2. blame A for B 3. be to blame; you are not to blame
* 4. put blame on somebody; #누군가를 비난하다.
* ##blame
* #구조; #anatomy, #structure, #composition - 구조 
* #구도

* (예술 작품의 짜임새) composition 
* 그림의 구도를 잡다 compose one's painting 
* 2. (여러 요소의 전체적인 모습) structure 
* 대결 구도를 형성하다 have confrontation (with) 
* carry out a large-scale #restructuring	 	#구조조정
* ㆍ서류: document = paper = form = file
* 서약서 waiverf
* [|dɔ:sieɪ;|dɑ:s-] assemble/compile a #dossier 관련 서류[자료] 일체를 모으다/편집하다
* 서류 가방; #attsche' = attache' case
* #서류 #서약서
* #회사 단어
* #인재상 person to need
* #일손이 부족해 							 We're short-handed today.
* needed #human resources
* #업무 능력 평가 							 performance review
* 어떤 업무를 할 때 가장 성공적으로 하고 있다 느끼나요? what #job tasks do you feel most 
* 업무의 강도가 세지는 시기; #crunch time
* 구조조정 						 corporate restructuring, shake-ups
* 경과보고 									progress report
* #휴게실 직원 휴게실								 a staff lounge
* #휴게소 									 rest stop
* 다시 일하게 됐어 I got my #job back
* #퇴직 #정년 퇴직 #명예 퇴직 retirement age, apply for voluntary[early] retirement 
* 그는 자진 #명예퇴직을 했다. He took voluntary redundancy
* #퇴직 수당 redundancy payment
* #사임 										 resign from
* #하차; unauthorised
* 그 감독은 팀의 성적 부진으로 하차했다
* The coach resigned due to the poor performance of the team. 
* 그는 시장 후보로 출마했다가 도중하차했다
* He ran for mayor but withdrew from the race before the election. 
* 나 #백수야	i'm looking for work(정적), i'm job hunting(활동적), I’m between jobs(잠깐 일을 쉬고있다는 느낌), i'm 
* i'm taking some time out to travel
* putting together my portfolio(체계적), 
* i'm unemployed(담백)
* job seeker xxx
* #뇌물을 줘서라도 다음 승진을 해야겠다. pɑːm even if I have to grease someone's palm.
* #bribery; take a / #reject the 
...
* #언덕 #거퍼룬	#hill #steep
* #경사로	#slope
* #계단	stairs 한 개: step, flight; three flights to walk up
* #stairwell
* 	walk up/down the stairs
* #go up the #hill / #go down the #slope
* staircase	stairway, step
* 계단을 이용하다 #엘리베이터	take the stairs/elevator
* 짝수층에만 스는 엘리베이터; this elevator is for odd=numbered floors 
* = serve odd-numbered floors <> makes stops on every other floor
* 10층 가시려면 이 엘리베이터 타세요; please take that elevator for the 10th floor.
* #elevator shaft; #승강기통
* 엘레비에터 타다 #get on the elevator
* 엘리벵터 탔어요 have taken the elevator
* 엘리베이터 내려간다 Going down
* 계단 #손잡이 ‘bӕnɪstə(r) banister handrail ’hӕndreɪl
* 올라가나요? Going up?
* 몇 층 가세요? What floor?
* 저 내릴게요 I'm getting off
* #에스컬레이터 손잡이	handrail escalator
* #go down/#go up the escalator	
* 손잡이	knob: 동그란 손잡이 nɑ:b
* #손잡이를 누른다 				squeeze the level
* #난간, 기둥	#handrail #pole #banister
* #run down	(#건전지 등이) 다 되다
* 계단을 달려 내려가고 싶었어. 			I wanted to #run down the stairs.
* 나에게 말하기를 겁나 일하라고 했어요. 	 	He told me to keep my nose to the grindstone. 
* 너가 판매 보고서를 보면, 우리가 우월한 위치에 있다는 것을 볼 수 있다.	If you look at the sales report, it's clear to see that we haveIlose) the upper hand.
* 우리는 그 회사가 규정에 맞지 않게 행동했기 때문에, 관계를 끊기로 결심했다. 		 	관계를 끊다. We decided to sever ties with the company because they didn't stick to the regulations.
* 그 공장의 새로운 생산라인은 최첨단이다 	The new production line at the factory is state of the art.
* 잡담 그만하고, 본격적으로 일을 시작하자!		Let's get down to business!
* 우리는 광고 캠페인을 사용함으로써 일을 시작해야만 한다.	We should get the ball rolling by starting the advertisement campaign.
...
* 평범한 직장생활이 지루했는데 			I'm tired of my nine to five life style
* 잡담 그만하고, 본격적으로 일을 시작하자!		Let's get down to business!
* 그녀가 문제를 일으켰다. 				She threw a spanner in the works 
* 그는 계속해서 사회적인 위치가 올라가는 중이다. 		 	he has been moving up in the world.
* #제품 시연	product demonstration
* 나는 출장 가는 것을 좋아한다. 왜냐하면 항상 하던 것과 다르기 때문이다	I enjoy going on business trips because it's a change of pace.
* #자기 계발서 어디있나요?				Where are the self help books.
* 이 제품은 충분히 자랑스러워 할 만한 가치가 있다.	This product is good enough to be a feather in his cap.
* 회사에 구조조정이 있을 시에 대부분 상위권 간부들이 먼저 해고당한다. 해고당하다	When a company is restructured, the senior staffs are often the first to get the axe.
* 어떤 학위를 가지고 있습니까? 	What degrees do you have?
* 전자공학 석사 학위를 가지고 있습니다. 	I have a master's degree in electronics.
* 언제까지 해야 해요?	When do you need it by? 
* 당신의 장점은 무엇이라고 생각하십니까? 	What do you think are your strengths?
* 아르바이트로 일하고 싶어요. 	Do you have any casual work? 
* 마감일이 언제예요?	When is your deadline? 
* 결과는 언제 알 수 있습니까? 	When will you announce the results? 
...
* 회사를 그만둔 이유는 무엇입니까? 	Why did you quit your previous job? 
* 회사가 경영난으로 문을 닫았습니다. 	The company shut down because of financial difficulties.
* 이 일에 대해서 아는 것이 있습니까? 	What do you know about this area? 
* 이 일의 어떤 점이 좋습니까? 	What do you like about this area?
* 저는 책임지고 일을 완수하려고 노력합니다. 	I have responsibility and perseverance. 1p3:rsə2vɪrəns
* 이 연락처로 연락 드리면 됩니까?	Can I reach you at this number? 
* 다음 주부터 출근하십시오. 	Come in to start next week. 
* 함께 일하게 되어 기쁩니다. 	I'm honored to be working with you. 
* 세금 빼고 월 천 달러예요. 	A thousand dollars a month after taxes.
* 어느 정도의 급여를 원하세요? 	How much are you thinking of in terms of payment? 
...
* #병가는 며칠까지 쓸 수 있어요? 	How many sick days do I have? 	 
* 병가내다	#call in sick
* 정년 #퇴직은 몇 살이에요? 	What is your retirement age? 
* #사직서가 처리되었습니다.	#resignation #accepted
...
* 복사해 주세요. 	I need a copy of this, please. 
* 저는 10월 10일에 뉴욕으로 출장 갑니다. 	I'm going on a business trip to New York on October 10th
* 파일 이름을 뭐라고 하셨어요? 	What did you say the name of the file was? 
* 저 대신 업무를 맡아 주세요. 	Please cover for me. 
* 제가 회의실로 모시겠습니다. 	Let me take you to the meeting room. 
* 요점을 다시 말씀해 주세요. 	Could you repeat the main point? 
* 누가 회의를 주재합니까? 	Who is presiding over the meeting? 
* 회의 의제는 무엇입니까? 	What is the agenda of the meeting?
* 오늘 회의는 이것으로 마칩니다. 	We'll wrap up today's meeting here.
* 십 분 휴식 후 다시 시작하겠습니다. 	We will start again after a ten-minute break.
* 저희와 거래해 주셔서 감사합니다. 	Thank you for doing business with us. 
* 거래가 성사되었습니다. 	The deal is complete. 
* 신제품을 보시겠습니까? 	Would you like to see our new product? 
* 지급 날짜가 언제입니까? 	When is the payment date? 
* 송장일자로부터 4주 이내에 지급해 주십시오. 	Please make payment within 4 weeks from the invoice date. 
* 지급 조건은 어떻게 됩니까? 	What are the terms of payment? 
* 협상하다 be in negotiation with
* 가격은 #협상 가능합니다. nɪ‘goʊʃiəbl The price is negotiable. 
* #협상이 난국에 부딪혔습니다. the negotiations #come to an impasse
* #재협상 #renogotiation
* #창가 쪽 테이블로 주세요	i'd like a table by the window =
* i'd like a table with a #view
* 협상/토론 대상에 놓다	on the table <> off the ##table
* #기여하다, 이득이 될 만한 것을 가져오다	#bring to the table
* #agenda
* #안건으로 제기하라 put on the table; Just put it one the table
* 안건이 #통과되었습니다; #motion is passed
* 안건은 처리되었습니다; #case closed
* #불법적인	#under the table/#counter
* 2. 매우 취한 상태
...
* #토론 debate	#토의 #discussion
* ##consult; consult A about B; i'd like to consult you about this issue
* #consultation is over
* #협상이나 #토론을 위해 모이다	#get around the table
