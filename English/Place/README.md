...
* 빵집 										 bakery [|beɪkəri
* 미용실 							 beauty parlor[pɑ́:rlər], hair salon [sə'lɑ:n]
* #놀이터 						#children playground [|pleɪgraʊnd
* #정글짐; #monkey bars
* #시소;  #teeter-totter seesaw
* 주차장 						 parking lot, parking garage [gə'rɑ:Ʒ;gə|rɑ:dƷ]
* 도매점 										 wholesale store
...
* #단방향, #반이중, #양이중; #implex, #half-duplex-Full-duplex(#duplex)
* #궤도 #방향량 #진로 #Vector; technical vectors
  * 진로: #career searching = #future dream
* #중앙; #at the core = #in the centre
* #저궤도; low earth orbit #정지 궤도; #geostationary earth orbit
* #orbit; the earth's orbit around the sun
* #정상 궤도에 있어 You're on the #right track
* #동서남북 #남쪽; #south of seoul; 대구, 안양 등 서울보다 남쪽; #southern seoul; 서울 남부; 강남, 서초
* #쌍방향; #bilateral; [|baɪ|lӕtərəl]; bilateral relations/agreements/trade/talks 
* #display =#arrange #set up #lay put #place #배치 첫 배치 first placement game
* #진열; #deployment; 배치 = #lay out = #arrange for
* #위치; #station
* by pus is putting me on a job in LA
* #부서 배치; department arrangemen; Which department do you work in? 
* 사방에서 					 everywhere = on all side = left, right and center
* #사방팔방; #On all sides
...
* 그는 방향 감각이 없어요 						 He’s bad with direction
* 방향을 바꿀 준비가 됐어 					 I'm ready to make that turn
* 나 역 근처야						 near+명사 I'm near the station.
* Can you tell me where the ~ is #located
* 여기 근처에 ATm 있어요? 			 근처에 라는 부사 Is there an ATM nearby?
* 근처에 있어 #stick around
* 사물이 ~에 위치해있다; i've had a jar of olives #sitting in my fridge forever
* #위치 #근처
* 1. [타동사][VN] …의 정확한 위치를 찾아내다
* The mechanic located the fault immediately.
* 2. [타동사][VN] (특정 위치에) 두다[설치하다] 참고 relocate
* They located their headquarters in Swindon.예문 발음듣기
* 3. [자동사][V + adv. / prep.] (특히 美) (특정 장소에서) 사업을 시작하다
* There are tax breaks for businesses that locate in rural areas.
* ##locate
* 저 티셔츠를 어디다 뒀더라? 					 Where did that t-shirt go?
* 자기 손을 그의 손 안에 슬며시 밀어 넣었다. 		(슬쩍) Anna slipped her hand into his.
* #두다 #놓다
* #duplex
* #bidirectional 미국·영국 [|baɪdə|rekʃənl;|baɪdɪ|rekʃənl;|baɪdaɪ|rekʃənl] <> #on-way
* #양방향
* 상황 설명
* 배경, 외모, 동작(눈, 손), 추측
* ㆍ배경: there is(are) + 인물(제일 처음 보이는 대상) in / at / on + 장소
* #배경; 배경도(Context diagram)
* ㆍ외모: He has 머리, is wearing 옷
* ㆍ행동: 현재 진행형으로 표현
* ㆍ추측: looks like
* ㆍ위치
* #위##에; #on top of that
...
* on the upper left side of	at the top
* on the upper side
* on the upper side of the picture	on the upper right side of
* on the left
* on the left side
...
* 이 셔츠 드라이클리닝해 주세요. 	I'd like to have this shirt dry cleaned. 
...
* 제길 #딸꾹질이 멈추지 않아					 Darn, the hiccups won't stop
* #트림 #방구 #소화
