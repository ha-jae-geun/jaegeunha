# 공제
* 세액공제: 세금 자체를 깎아준다; 세금 자체를 깎아주는게 공평하다라는 말이 있지만 
	* 연봉은 5천만원인데 병원비로 2천만원 쓴 사람, 연봉은 3천만원인데 병원 한번도 안 간 사람중에서 병원 많이 간 사람이 더 세금을 많이 내게 될 수도있음
* 소득공제: 내가 번 돈중에 얼마를 제외하고 세금을 매기겠다; 부자들에게 훨씬 유리한 제도

# 카카오 뱅크
* 속도; 10초 이체, 60초 대출, 7분 계좌개설
	* 공인인증서 필요없는 계좌이체
* 적은 수수료
	* 적은 해외 수수료
...
## 화폐가치
* 본인 나라의 화폐 가치가 내려가야(흔해져야) 수출이 활발해짐
...
* #transit number; 등록 은행 번호
* open an (bank(account 계좌를 열다, account number 계좌번호, balance 잔고, #잔액 조회; I want to check my balance, #요금 납부; I want to pay my bills, bank statement 은행 계좌 통지서, * * teller 출납계원, automatic teller machine (= ATM) 현금 자동 인출기, deposit 예금, withdraw 인출하다, transfer 이체하다, cash a check 수표를 현금으로 바꾸다, loan 대출, interest rate 금리, * exchange rate 환율, remit 송금하다, checking account 당좌 예금 계좌, savings account 보통 예금 계좌, personal check 가계 수표, money order 우편환, bank book 예금통장
* #waive; #자금 반환 #total credit; #현금 잔액
* #pay to mobile; #모바일 결제; #pay pass; #터치식 결제
...
* #거래를 놓치다; #lose business = #lose customers
* #초과하다; #exceed = go beyond = #go over = #surpass
* #pay increase; #임금 인상
* #매출액; #sales figures #sales #turnover #total sales amount #takings
* #수익; #increase #rise #profit in
* 수익을 증가시키다; #attract/draw more customers = #boost sales = #Improve profits
* #하락; #decrease in / #loss of / #reduction in
* #실적; #performance #result #record #achievement; #성과금; #performance pay
* #feat; it was a #astounding feat
* #이달의 사원; #employee of the month
* #사업을 확장하다; #expand #extend #enlarge the business = #Open a new store = #branch
* Project Appraisal; #사업 평가서; [ə|preɪzl]
* #pet project; 좋아하는 사업

* 온라인으로 들어가	Go ##online
* (표를 온라인에서 살 수 있나요?	○ Can we buy the tickets online? )
* !뉴턴 은행에서 #온라인 계좌를 만들다	create an online account with newton bank
* 부분합: #subtotal, #판매세: #sales Tax; 6% of $10 is 60cents
* 세금과 죽음만큼 확실 #certain #as death and taxes
* ##FICA(Federal insurance Contributions Act; 국민 #연금 공단)
* #연금; #pension, #annuity; receive[draw] one's pension 
* #연말인데, 한번 봐야지 			 Let's meet up as the end of the year is drawing near.
* *연말 #정산 year-end tax adjustment; do the adjustment; after the year end tax adjustment
* *#원천 징수 #보험료 #소득세 #세무사 #withholding tax #insuarance rate #income tax; #tax accountant
* #총소득; #gross income(#income)
...
* #자본 이익; #capital gain 
* #세금
* 대출금 융자금 					 mortgage, loan 미국식 [|mɔ:rgɪdƷ]
* #주택 대출 #Mortgage
* #담보; #mortgage
...
* financial crisis; the global financial debacle. [deɪ|bɑ:kl;dɪ|bɑ:kl]
* 대출을 갚다, 받다 #pay off a loan/#debt = #pay in full <> #take out a loan
* #상환일 #due
* #만기일 #expiration date <> #발급일 #issued date 
* #만료되다; #expire; #void; when does your visa expired?
* #유효일 #effective date
* #유효기간이 언제까지인가요? what is the #expiration date on your card?
* 언제까지 유요해? when is it #good through = when is it effective through
* 아직 유효해? it the offer still good?
