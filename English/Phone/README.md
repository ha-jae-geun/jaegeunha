...
# 사진
* 수직/수평으로 찍다; vertically/horizontally
...
# 전화
* 누구세요? WHo is this?(너무 직접적인 표현) -> Who am i speaing to?
* 참고로 # booty call 이라는 표현이 있는데요, 괜히 그날 따라 기분도 꿀꿀하고, 외로움을 달래기위해 전애인이나 좋아하지도 않는 사람에게 연락하는 것을 말합니다. (에라이!) 
...
* #blue box ((장거리 전화를 공짜로 걸기 위한 불법 소형 전자 장치))
