...
* 변화
* ⦁#present 앞강세: 1.현재의(프레전트) 2. 선물(프레전트) 3. 뒤 강세: 수여하다(프리젠트)
* ⦁#close: 형용사 s, 동사 z
* ⦁##use 사용: s, 동사: z
* ⦁#separate: 형용사 'seprət 동사 'sepəreɪt 형용사는 이, 동사는 에이
* ⦁#graduate: 형용사,명사 'grӕdƷuət 동사 'grӕdƷueɪt
* ⦁#duplicate 사본; 사본을 만들어 주다 [noun, adjective doo-pli-kit, dyoo-; verb doo-pli-keyt, dyoo-] 
* ⦁##certificte 수료; 수료증을 발급해주다 [noun ser-tif-i-kit; verb ser-tif-i-keyt] 
* ⦁##tear [teer] 찢다 [tair] 
* ⦁#record [verb ri-kawrd; noun, adjective rek-erd] 
* ⦁#contract [noun, adjective, verb 15–17, 21, 22 kon-trakt; verb kuh n-trakt] ; 강세 위치
* ⦁#extract 명사: 엑스 동사: 익스

* 같은 발음
* ⦁ascent- 올라감, 상승 assent- 찬성
* ⦁#discreet: 신중한;[dɪ|skriːt] #discrete: 별개의 [dɪ|skriːt]
* ⦁#serial: 연속극, #cereal: 곡물 [|sɪriəl] 
* ⦁#dual: 두 부분으로 된, 이중의 | #duel: 결투 [|duːəl] 
* ⦁#wreath: 화환 [riːθ], #wreathe: 둘러싸다, 둥글게 움직이다 riːð
* ⦁#address; 어: 주소, 에; 연설하다
* ⦁##our 사이에 들어가면 ‘are'발음과 비슷
* ⦁#clothes [kloʊðz;kloʊz] 단수, 복수 발음 같음
* ⦁#aural; #청각의 #oral- 구두의
* ⦁#cord: #끈 #chord; #화음 [|pӕlət] 
* ⦁#serial; #연속극 #cereal
* ⦁#capital- 수도 #capitol- 미국 #국회 의사당
* ⦁#balmy- 아늑한 [|bɑːmi] #barmy- 약간 제정신이 아닌
* ⦁altar- 제단, alter- 바꾸다, 변하다
* ⦁#breach- 위반 #breech- (총의) 약실 [briːtʃ]
* ⦁#elicit- (정보・반응을 어렵게) 끌어내다 #illicit- 불법의 [i|lɪsɪt]
* ⦁#birth- 탄생 #berth- 침상 [bɜːrθ]
* ⦁#descent- 내려오기 [dɪ|sent] #decent- (수준・질이) 괜찮은 [|diːsnt]
* ⦁#broach- (하기 힘든 이야기를) 꺼내다 #brooch- 브로치
* ⦁#dose- (약의) 복용량 #doze - 깜빡 잠이들다
* ⦁#pray- 기도하다 #prey- (사냥 동물의) 먹이
* ⦁#poll #여론조사 #pole; #막대기
* ⦁#hoard- 비축물 #horde- (사람들의 큰) 무리 	 [hɔːrd] 
* #hoarding; #광고판 2. 저장, 비장, 퇴장, 축적
* ⦁#pour- (특히 그릇을 기울이고) 붓다 #pore- (피부의 땀구멍 같은) 구멍
* ⦁#queue- (사람・자동차 등의) 줄 #cue- (무엇을 하라는) 신호
* ⦁#cord- 끈 #chord-화음
* ⦁#dual - 두 부분으로 된, 이중의#duel - 결투 [|duːəl]
* ⦁#site #sight
* ⦁#aloud; 소리내어 #allowed 
* ⦁#coarse- 거친 #course- 강의
* ⦁#barren- 척박한 #baron- 남작 [|bӕrən]
* ⦁#palate- 구개(입천장) [|pӕlət] #palette- 팔레트
* ⦁#currant- (케이크 등에 넣는 알이 잔)건포도 #current- 현재의 [|kɜːrənt]
...
* ⦁#prescribe- 처방을 내리다 #proscribe- (공식적으로) 금하다
* ⦁#inability- 무능 #disability- (신체적・정신적) 장애
* ⦁#exercise- (건강을 위한) 운동 #exorcise- (기도·의식 따위로) 내쫓다; 미·영 [éksɔːrsàiz,-sər-] 
* ⦁#foreword- (책의 짤막한) 서문 #forward- (위치가) 앞으로
* ⦁#all together- 다함께 #altogether- 완전히
* ⦁#personnel- (조직・군대의) 인원 [|pɜːrsə|nel] #personal- (소유・관련성이) 개인의 [|pɜːrsənl]
* ⦁#drown- 익사하다 #drawn- 핼쑥한
* ⦁#peddle- (여러 곳으로) 팔러 다니다 #pedal- 페달
* ⦁#diffuse- 널리 퍼진 [dɪ|fjuːs] #defuse- (긴장・위험 등을) 진정시키다 [|diː|fjuːz] 
* ⦁#crayon- 크레용 #canyon- 협곡
* ⦁#founder- 창립자 #flounder- (어쩔 줄 몰라서) 허둥대다; [|flaʊndə(r)]
* ⦁#immoral - 비도덕적인 #immortal - 죽지 않는
* ⦁#censure- 견책, 비난 #censor- 검열관 [|senʃə(r)] [|sensə(r)]
* ⦁#sceptic- 회의론자 #septic- 패혈성의
* ⦁#statute- 법규 [|stӕtʃuːt] #statue- 조각상 	 [|stӕtʃuː]
* ⦁#causal- [|kɔːzl] 인과 관계의 #casual- 무심한, 격식을 차리지 않은 [|kӕƷuəl]
* ⦁#phase- 단계 #phrase- 구절
* ⦁#rhyme- 운, 운문 [raɪm #rime- 서리 [raɪm]
* ⦁#bazaar- 상점가 [bə|zɑː(r)] #bizarre- 기이한 [bɪ|zɑː(r)]
* ⦁#bough- (나무의 큰) 가지 [baʊ] #bow- 활 [boʊ] #bow 인사; 	 [baʊ]
* ⦁#expend- 쏟다 #expand- 확대되다
* ⦁#canvass- 유세를 하다 [|kӕnvəs] #canvas- 캔버스 천 [|kӕnvəs
* ⦁#gasp- 숨이 턱 막히다 [gӕsp] #grasp- 꽉 잡다 [grӕsp]
* ⦁#definitely- 확실히, 분명히 #defiantly- 반항적으로
* ⦁#content- 내용물 #contend- (특히 언쟁 중에) 주장하다
* ⦁#bean- 콩 #beam- 빛줄기
* ⦁#council- (지방 자치 단체의) 의회 [|kaʊnsl] #counsel- (전문가에 의한) 조언
* ⦁#scare- 겁주다 #scarce- 부족한
* ⦁#frieze- 프리즈 #freeze- 얼다
* ⦁#buoy- (물속에 띄우는) 부표, 기분을 좋게 하다 [bɔɪ ; 美 또한 |buːi]
* ⦁#resent- 분하게 여기다 [rɪ|zent] #recent- 최근의 [|riːsnt] 
