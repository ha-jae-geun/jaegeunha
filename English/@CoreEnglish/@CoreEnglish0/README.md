...
# 강세
*  `(왼쪽 위에서 아래로) 표시  ===> 제 2 강세 `
 * '(오른쪽 위에서 아래로) 표시가 ===> 제 1 강세로 액센트를 말해요 
 * 제1강세는 강하게 제2강세는 약하게 하시면 됩니다. 
* 단어의 발음은 보통 슬래시(/)나, 역슬래시(＼) 사이에 쓰여 있습니다. 
	* 단어는 보통 대시(-)로 음절이 분리되어 있습니다.
	* 강세가 있는 음절 (더 강하게 말해야 하는 부분) 은 아포스트로피(‘)로 표시되어 있습니다.
	* 두 번째 강세 (긴 단어에서만 나타나는 약간 강한 음절) 는 콤마(,)로 표시되어 있습니다.
...
·이 둘을fricative  [ˈfrɪkətɪv]  마찰음이라고 합니다. 아랫입술과 윗니가 마찰하여 새듯이 소리 나는 발음이죠. F발음이 V발음보다 좀더 깊고, 많이 입술을 물어줘야 하고, V사운드는 상대적으로 좀더 진동(울림)을 줘야 해요. 이 문장으로 연습해 봅시다.
...
1. 움직임이 느껴지는 소리이며
2. '우으어'를 빠르게 발음합니다.
*  '우으어' 를 발음할 때, 입술 모양의 시작 지점은  입술을 많이 오므리는 장모음 우 [u:]와 달리 '우리말 [우]'를 편하게 말할 때와  비슷한 모양에서 시작합니다.  (섹시한 우~ 정도의 입모양) 
	*   good [gʊd]; good [gʊd] & cook [kʊk]
	* wood 는 '우드'가 아닌 '우워ㄷ
...
* #기타; d 묵음
* #handkerchief, #handsome, #sandwich(블), #wednesday

* #gn으로 끝나는 경우 g 묵음
* #design #foreign(블) #resign #sign

* #h# he -> 이 have -> 애브

* 프랑스어가 어원인 단어중 h로 시작하는 단어는 h묵음
* #henry #heir(블) #honest #honor #hour

* c, g, r 다음에 오는 h는 주로 소리가 나지 않는다.
* #echo #choir(블) #ghost #rhino

* #kn#으로 시작되는 경우 k 묵음
* #knee #knife #knob #knock #know

* a, o, u 다음에 오는 l은 주로 묵음
* #calm #half #palm #salmon #talk #yolk(블) #walk #could #could #would #should

* #mn#로 끝나는 경우 m 다음에 오는 n은 소리가 나지 않는다.
* #autumn #column #damn

* #ps# #pn으로 시작하는 단어에서 p 소리 나지 않는다.
* #psychic #psychology #pneumonia(블)
...
* 기타 t 묵음
* #castle #mortgage #christmas #often #fasten #soften(블) #listen #whistle #match

* 프랑스어가 어원인 t로 끄나는 단어들은 묵음
* #ballet #chevrolet #bouquet #debut(블) #buffet #valet
