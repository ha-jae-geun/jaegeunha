...
# 화상
* 오줌에는 세균이 없다.
	* 소변은 암모니아가 아니라 요소이다. 암모니아는 요소로 바뀌어서 우리 몸핏속에 떠다닌다. 
	* 소변은 보고 손을 씻으라는 이유는 화장실에 워낙 세균이 많을 수 있는 환경
	* 화상을 입으면 깨끗한 정제수 같은 물로 씻으라고 권하는 건데 오줌에도 세균이 없으니
	* 화상을 입었을 때는 우리몸의 체온보다 약간 낮은 20-25도의 물로 닦아내는게 가장 좋다.