...
# 쓸만한 영어 - 미세먼지 - 오늘 미세먼지가 많은 날씨???\영어공부\영어회화
 *  실내 공기가 답답해요.
 *   실내 공기가 텁텁해요.
 ...
 *         의미: 실내 공기가 너무 나빠
 * 
 *  - 탁한 공기 때문에 내가 답답함을 느낄 때
 *    - 코가 꽉 막혀서 답답한 느낌 stuffy
 *       It's stuffy (in) here. 여기 공기가 답답해요.
 *       It’(s s)tuffy here. [발음주의]
 *    ※ 주의 
 *      I feel stuffy라고하면 내 몸에 문제로 답답하다는 뜻이 돼요.
 * 
 * - 집 안에서 담배를 피거나 요리할 때 연기/먼지 등으로 생긴 탁한 공기 상태는?
 *   - ‘대기오염’하면?  air pollution
 *    ♠ pollute
 *      해를 끼치는 (나쁜)것들로 더럽히는 그림
 *   - indoor (air) pollution 실내공기가 더러운 그림 → 실내 공기 오염
 *     We have indoor (air) pollution. 실내 공기가 탁해.
 * 
 *   ▶    
 * - 미세먼지가 많은 날이야.
 *   오늘 미세먼지가 꼈어. 
 *   →  미세먼지가 날씨???
 *   - It’s sunny today. 오늘 날씨 맑아/화창해.
 *     It’s cloudy today. 오늘 구름이 많이 꼈어/흐려.
 *     It’s rainy today. 오늘 비와.
 *   ⟹ (미세) 먼지가 많이 낀 날이야.
 *      → It’s micro dusty today??? 날씨로 표현할 수 있을까요? ☞ 날씨가 아님.
 *     * 먼지함량/농도에 따른 공기의 오염도(air quality)를 나타냄.[공기의 질이 좋다/나쁘다]
 *       날씨를 뜻하는 어떤 기상현상이 아님.
 * 
 * ♠ dust의 그림 
 *   1. 땅에 떨어진 작고 더러운 물질
 *   2. 공장 연기/분진 또는 자동차 배기가스에서 나온 더러운 오염 물질의 그림 (예 낙진..)
 * 
 * ♠ smog 
 *    [스마ㄱ] * 미국식발음 
 *   smoggy 
 ...
 * ⟹ It’s smoggy today.
 *    오늘 스모그가 많다.
 *    * 우리나라 미세먼지는 중국공장매연(/사막)먼지로부터 
 *      발생하는 것이기 때문에 smog현상으로 볼 수 있겠죠?
 * 
 *  - smoggy 
 *    [스마기] 스모그가 낀
 *  * 지역차가 있을 수 있지만 만약 미영어권에서 smoggy [스모기] 라고 하면
 *   이해를 잘못하거나 [스마기]로 바꾸어 말하는 것을 볼 수도 있어요.
 *     It’s smoggy today. 
 *     오늘 스모그가 많이 꼈네.
 * 
 * - 직역: 대기(공기)질이 나빠.
