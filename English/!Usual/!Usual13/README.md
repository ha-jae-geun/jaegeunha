 ...
 *   learn :  모르던 것에 대해 새롭게 알게되는 그림
 *    → 다음 문장을 영어로 바꾸어 보세요
 *        (단 한 단어라도 좋습니다~^^)
 *        "너에 대해 더 알고 싶어."
 *        I want to learn about you.
 *        너에 대해 배우고?? 싶어. (이상하죠?)
 *       너에 대해 몰랐던 것을 새롭게 아는 그림
 * 
 *    → 다음 문장을 영어로 바꾸어 보세요
 *        (단 한 단어라도 꼭 해보세요~^^)
 *        (그 여자는) 그가 바람폈단느 사실을 알고 충격에 휩싸였다.
 *        She was shocked after learning about his affair.
 *        그녀는 그의 바람에 대해 배운후??? 충격받았어.
 *         몰랐던 것을 새롭게 알게된 그림이 확실히 보이지요?
 * 
 * ==========
 * 
 * [쓸만한 영어] 2018년 6월 14일 영상
 * 요가, 수영, 헬스클럽, 미술학원 등록시
 * 
 * - 자유형/배영 할 줄 알아.
 *   know : 사실을 알고 있는 그림
 ...
 * - deserve
 *   de-와 같은 접두사가 붙은 후 
 *    -serve([절ㅂ]로 발음이 바뀌는 다른 동사들
 * 
 *   observe
 *    preserve
 *    reserve
 * 
 * - 어원을 찾을 때에는 단어를 분석하기 위한게 아니라 
 *   내 공부의 효율을 높이기 위해 참고만 하는 정도가 좋습니다.
 * 
 * 
 * ◇ serve
 *   이 단어를 봤을 때
 *   여러분은 가장 먼저 떠오르는 그림은 무엇인가요?
 *   serve food : 음식을 서빙하다
 *   serve in the military : 군복무를 하다
 *   serve jury duty : 배심원으로 참석하다
 *   
 *   ⇒ 공통적인 기본 그림은?
 * 
 *        (맡은 일/ 주어진 일/ 할 것) ~을 (해)주는 그림
 *         1) 음식을 주는 일을 맡아서 음식을 주면 serve food
 *          2) 나라를 지키기 위해 나를 주면(바치면) serve in the military
 *          3) 국민의 의무중 하나인 배심원에 참석해 그 일을 수행하면 serve jury duty
 *              미국시민은 배심원 참석 의무가 있음
 * 
 *   접두어 de-
 *     더 구체적으로 쪼개어 반대의 의미 갖게됨
 *     예)  1) compose : 요소를 구성해서 하나로 만드는 그림
 *                                 - 작사/ 작곡/ 작문하다.
 *               decompose : 그 요소를 쪼개어 분리/ 분해하는 그림
 *                                     - 분해/ 부패하다.
 *              
 *            2) scribe : 전체 글을(말하는) 쓰는 그림
 *                             - (~을) 적다/ 쓰다
 *                scribble scribble : 개발새발 흘려쓰다..
 *                describe : 자세하게 나누어 구체적으로 말하는(쓰는) 그림
 *                                - 묘사(서술)하다
 * 
 *   ⇒ 그럼 deserve의 그림은?
 *         → 내가 주었던 것/ 내가 한 행동들에 대해 그 값/ 대가를 되돌려받는 그림
 *             따라서 누군가가 이전에 한 무엇이 전제로 있다는 것을 알 수 있음
 * 
 * 
 * ◇ deserve
 * 
 * - receive sth. according to what your action was
 *   본인이 한 행동에 따라 되돌려받는 그림
 * 
 * - 나쁜 의미로만?
 *   나쁜 의미로만 쓰이는게 아닙니다.
 * 
