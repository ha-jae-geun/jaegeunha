...
* 가죽 보관함이야; #leather holder
* #보관 #보존
* 비즈니스 회화와 공손한 표현에서 즐겨 쓰는 표현
* #let me
* 결벽증 심하다. 							 You're such a clean freak.
* #my·so·phil·i·a; #mysophobia
* #결벽증
* 괜히 그런게 아니였네, 그럴만 했네 			no wonder ~~ = it’s up there
* 그럴수도 있지 						 It happens! That happens! Shit happens.
* 그럴 줄 알았어 							 That figures, that’s what I figured
* 그럴 줄 몰랐다 I didn't see it coming
* #그럴만 했네 #그럴 수 있지 #그럴 수도 있지 #그럴 줄
* 딸기잼										 strawberry jam 
* 이 컬러 프린터 종이가 #낀 것 같은데..		 It seems that this color printer is jammed 
* 아침 교통체증이 정말 #지겨워 				I'm really fed up with morning traffic jam
* 너가 어려운 상황이면, 내가 즉흥연줗ㄹ 수 있어; I fou're in a jam, I can jam
* ##jam; 스타일; that's my jam
* #jam
* #할게요 				 get 목적어 p.p get 목적어 ordered, get 목적어 delivered
* #get
* make sure to / make sure that S+V / mare sure of 무엇
* #make sure
* #헷달 88#
* #as of yet = #as yet
* ☆it's not for sure yet
* #so far, we've only decided where to go
* we haven't decided on a specific date, yet
* get round to it/v-ing; 아직 ~ 안했는데; I didn't get round to writing the letter
* 아직도 먹고있냐 							 You are still eating?
* 이정도는 약과야							 You haven't seen anything yet.
* #아직 #약과
* 불법 다운로드도 하지 않았는데				 I also did not download #pirated data
* #불법의; #unauthorized
* #불법적인	#under the table/#counter
* 2. 매우 취한 상태
* #불법
* 왜 내 컴퓨터에 바이러스가 생겼을까?		 How did my PC become infected with a virus?
* 그리고 악성코드도 너무 많아				 It also picked up a lot of #malwares
* #바이러스 #악성코드
* 대단한; I am some guy
* ##some
