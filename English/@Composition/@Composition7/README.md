 ...
 * 
 * #헷달 10#
 * 자세히 보면 여기서 우리 집이 보이기는 해요. look (특정한 방향으로) 보다[바라보다 / 쳐다보다]:
 ...
 * 한번 생각하는 것 I'm trying to think about where to go for my vacation. 
 * ㆍfind: 어떤 것을 찾는 것 
 ...
 * insist, assert, argue, calim, insist[maintain;claim] on, plead[pliːd]
