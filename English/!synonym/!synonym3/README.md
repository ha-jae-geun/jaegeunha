...
* 말 그대로 급작스럽게 솟는 것을 의미하는데요, 파도가 높이 솟는 것에도 쓰는 단어 입니다. 동사로도 [급증하다] 라는 의미로 쓰이며, 뒤에 목적어로 [감정/기분] 따위가 오면 그 감정이 솟구쳐 [휩싸이다] 를 의미합니다. 다수에 의한 강력한 반발을 의미합니다. 보통 정치적, 사회적 이슈에 대한 반발입니다. 3) class action (suits) : 단체소송
* 난 그 마케팅 실패를 낮은 예산 탓으로 돌리고 싶어. ex) I'd like to chalk the marketing failure up to the low budget.
