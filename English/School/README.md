# 학용품
* [명사] (보통 뚜껑을 여닫을 수 있는) 책상 bureau 미국식 [ˈbjʊroʊ] 
...
# 대학
* # 모교; Alma Mater 미국식 [ˌælməˈmɑːtə(r);ˈmeɪtə(r)] 
...
* #팀을 이루어 일하다: work in teams #대중 #정서 Polular #sentiment
* #large crowd
* #대중 매체 #mass media
* 일반대중; the public #at large
* #인성을 함양하다 #build strong character
* #인격 발달: personality development
* 인간 #본성 #human nature
* 긍정적인 #자아상을 형성하다 develop a positive #self-image
* #정체성; i'm losing #touch with my #roots
* #중등 교육 secondary education
* #정규 #교육 #formal scholling
* #전인 교육 a $well-rounded(#round) education
* #남녀 공학 #co-ed school <> single-sex school
* #미국 학교
* #varsity; 체육 특기생
* 그 학생의 모든 학생들이 1개 이상의 스포츠팀에 소속이 되어 있는 스포츠 클럽
* 운동 능력 좋은 학생들은 육상, 수영같은 인기 종목에 모이고 아니면 비인기 종목으로 밀려나게 됨

* 급식
* 피자, 파스타, 멕시칸 음식, 햄버거, 마카로니 앤 치즈 등 나옴

* 댄스 파티, 홈커밍, 프롬
* 댄스 파티: 1년에 1~2번
* 홈커밍: 1년에 한번: 선배들이 올 수 있음
* Prom: 1년에 한번: 11,12학년들이 파트너 데리고 참여, 여자는 드레스, 남자는 턱시도를 입고 아침에 남자들끼리 돈을 모아서 리무진을 타고 데리러 가기도 함, 파트너에겐 남자는 옷에 달 꽃, 여자는 팔에 달 꽃을 서로가 준비해 줘야 함, 누구와 프롬을 참여했는지 사진은 거의 평생 남음.

* 등교
* 교복 있는 학교는 사립 학교
* 여자: 파자마 + 어그 부츠 자주 입고 다님
* 남자: 후드티, 셔츠 + 청바지

* 수업 방식
* 수업 시간: 일찍 시작 > 90분, 쉬는 시간 4~10분 
* 방과후: 2:30~3:00

* 스쿨버스
* 매우 단단하다. (SUV와 부딪치면 SUV 부서지고 버스 꿈쩍 안함)

* 문구
* #필기 #옮겨쓰다; #move into; #move her stuff into my notebook
...
----------------------------------------------------------------------
* ㆍ교복 입는 학교 20%도 안된다
* ㆍ화장 된다, 염색 안된다, 수염 안된다, 삭발 된다
* ㆍ등교 차로 등교한다, 16살 면허증, 학생, 선생님들을 위한 주차장 따로 있다.
* ㆍ모든 학교에 경찰 사무실이 항상 있다.
* ㆍ급식 시간에 지키는 선생님이 있다. 시끄러우면 silent lunch, 영화의 반찬 던지는 싸움
* ㆍ#커터칼은 무기라고 생각
...
* #미국 #일진
* ㆍ담배보다 더한 마약
* ㆍ주먹이 아닌 칼과 총 -> 일부 학교는 금속 탐지기도 사용
* ㆍ#문신: 눈물 문신은 사람을 죽였다는 뜻
* ㆍ가장 하드코어 갱으로 알려진 bloods 와 Crips
* ㆍjuvenile detention : 청소년 교도소 dʒúːvənəl
* #미국 대학
* ㆍ학생이 학비를 못내면 정부가 내준다.
* ㆍ캠퍼스 내부 시설이 매우 중요하다
* ㆍ교육직 직원보다 관리직 직원이 더 많다
* #독일 학교
* ㆍ학비가 없다
* #캐나다
* ㆍ이러한 교육과정을 바탕으로 학교는 사립학교와 공립학교로 나누어져요. 공립학교는 정부에서 운영하며 고등학교까지 학비가 무료입니다.
* ㆍ사립학교는 우리와 마찬가지로 기업 혹은 개인이 운영하며 수업료를 내고 다녀야 합니다.
* 하지만 이곳은 우리나라 통념처럼 꼭 사립학교가 공립학교보다 여러 면에서 나은 것만은 아닙니다. 상류층이 인맥을 위해 다니는 곳도 있고, 발도르프 교육(대안 교육의 일종)처럼 특별한 커리큘럼을 가진 곳도 있으며, 크리스천 스쿨처럼 종교적인 곳도 있습니다. 하지만 대부분 사립학교는 고등학교 크레딧을 따기 위한 곳으로 작은 규모의 학원식 학교입니다.
* ㆍ캐나다 시민권자, 영주권자는 물론이고 부모 중 한 명이 워크 퍼밋((외국인의) 취업 허가증)을 가지고 있거나, 전문대 이상의 학교에 다니고 있는 신분일 때도 캐나다의 모든 공립학교를 무료로 다닐 수 있어요. 
* ㆍ불어학교 등록아이가 j.k 올라갈 때와 3학년일 때 신청 조건을 줘요. 인터넷으로 기한 내에 신청해야 하며, 교육청에서 보내는 확인 메일에 반드시 재확인해야 하죠.
* ㆍ유학생의 학교등록 5월까지 학교등록이 가능해요. Elementary school의 경우 신청서, 예방접종기록서, 출생신고서, 신분증, 부모 혹은 후견인 서류, 주소지 증명편지, 학비영수증을 교육청에 제출하면 학교신청이 가능하죠. Secondary school의 경우에는 성적증명서도 함께 제출해야 해요.


* desk	workstation [‘w3:rksteɪʃn]
* chair	stool(등받이 없는 의자)
* 언제 #개학해? 							 When does school start?
* 내일 개학이야					 I“m going back to school tomorrow
* a new #semester will start tomorrow
* 이제 당신 #차례야 						 The ball is in your court
* it's your turn = you're #up
* #번걸아 가면서; going to take it turns
* 지금 #몇과를 할 차례인가요? 					What lesson are we on now?
* #단원; What unit are we on now?
* 어디까지 했나요? 					 Where did we get up to last night? 
* 지금 어느 단원을 할 차례인가요? 				 What unit are we on now? 
* 지금 몇 페이지 할 차례인가요? 				What page are we on now? 
...
* 너무 많이 #나갔어 #진도 					 you are skipping ahead
...
* 아기를 낮에만 맡기고 싶어요. 	I'd like to leave my baby only for the daytime. 
